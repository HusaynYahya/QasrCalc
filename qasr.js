...
(function () {
  ...
  /* The Greater Toronto Area, asked for by name and put together from the
     ...
     the eleven towns of York and Durham that are in the GTA, named one at a
     time because their regions are not — Durham runs east past Bowmanville
     and north to Port Perry, York north to Lake Simcoe at Keswick, and
     Clarington, Scugog, Brock and Georgina come with them.

     One ring, not sixteen. Two towns that touch are published from the same
     ways, so the edge one walks west to east its neighbour walks east to
     west; an edge that appears both ways round is a wall between two of
     them and not part of the outside. Dropping those and walking what is
     left leaves the outline round the whole. 3,840 such edges went, and the
     rest closed into a single loop — drawn, it is one line rather than a
     county map.

     5,473 km², against 2,307 for London. The merge moves no point and
     changes nobody's side: it drops edges that agree to the last decimal.

     Nothing here is drawn by hand or traced from a picture. tools/trace-area.html
     fetches it, merges it, thins it to a hundred metres, and refuses to
     offer anything that puts a known place on the wrong side.              */
  var GTA = [
      [-79.54069, 43.57961],
      [-79.54172, 43.58280],
      [-79.52770, 43.58698],
