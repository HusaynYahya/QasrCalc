...
(function () {
  ...
  /* The Greater Toronto Area, asked for by name and put together from the
     answers: the City of Toronto, the regions of Peel and Halton whole, and
     York and Durham named town by town. Sixteen parts, kept apart rather
     than merged — the only question ever asked of a boundary is whether a
     place falls inside it, and any one part answers that.

     York and Durham are not taken whole because they do not stop where the
     GTA does. Durham runs east past Bowmanville and north to Port Perry;
     York runs north to Lake Simcoe at Keswick. Clarington, Scugog, Brock
     and Georgina are in those regions and are not in this boundary, so the
     eleven towns that are get named one at a time instead.

     5,473 km², against 2,307 for London. Taking the five regions whole
     came to 7,796 and stretched from Burlington to Beaverton, about 130 km,
     all of it counting as one city and prayed in full; this is the narrower
     reading, and the one the four places above decide.

     Nothing here is drawn by hand or traced from a picture. tools/trace-area.html
     fetches it, thins it to a hundred metres, and refuses to offer anything
     that puts a known place on the wrong side.                             */
  var GTA = [
    /* City of Toronto */
    [[
      [-79.63928, 43.74984],
  ...
  var RING_ROADS = [
    ...
    { city: "Greater Toronto", area: "Ontario", edge: "GTA boundary",
      box: [43.28, -80.17, 44.27, -78.78],
      shape: { type: "MultiPolygon", coordinates: GTA },
      areaKm2: 5473 }
  ];
