...
(function () {
  ...
  /* The Greater Toronto Area as the map publishes it: the City of Toronto and
     the regional municipalities of Durham, York, Peel and Halton, fetched by
     name rather than traced from a picture. Five parts, kept apart rather
     than merged — the only question ever asked of a boundary is whether a
     place falls inside it, and any one part answers that.

     It reaches further than the outline traced from the screenshot did. That
     one stopped short of Scugog, Clarington and Georgina; the regions include
     them, so the boundary now runs to Lake Simcoe in the north and past
     Bowmanville in the east. 7,796 km², against 4,939 for the tracing and
     2,307 for London.

     That is a large claim: Burlington to Beaverton is about 130 km, and all
     of it now counts as one city and is prayed in full. Whether common usage
     joins the whole of it is a judgement, and not mine to make — the regions
     are what "the GTA" names, and the GTA is what was asked for.             */
  var GTA = [
    [[
      [-79.63928, 43.74984],
      [-79.58882, 43.66460],
